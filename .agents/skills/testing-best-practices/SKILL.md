...
This skill provides rules for designing Laravel tests. Each rule file explains what to do and why. Use `search-docs` for Laravel API syntax. Fetch the PHPUnit 12.5.31 documentation at `https://phpunit.de/documentation.html` for PHPUnit API syntax.
