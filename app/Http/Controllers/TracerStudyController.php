...
class TracerStudyController extends Controller
{
    ...
    protected array $prodiList = [
        ['nama' => 'S1 Teknik Informatika', 'kode' => '55201'],
        ['nama' => 'S1 Teknik Sipil', 'kode' => '22201'],
        ['nama' => 'S1 Agroteknologi', 'kode' => '54201'],
        ['nama' => 'S1 Teknologi Pangan', 'kode' => '54211'],
        ['nama' => 'S1 Manajemen', 'kode' => '61201'],
        ['nama' => 'S1 Akuntansi', 'kode' => '62201'],
        ['nama' => 'S1 Hukum Syariah (Hukum Keluarga)', 'kode' => '74201'],
        ['nama' => 'S1 Pendidikan Bahasa Inggris', 'kode' => '88203'],
        ['nama' => 'S1 Pendidikan Agama Islam', 'kode' => '86201'],
        ['nama' => 'S1 Pendidikan Guru MI', 'kode' => '86202'],
    ];
    ...
    public function submit(Request $request)
    {
        ...
        $response = TracerResponse::updateOrCreate(
            ...
            [
                ...
                'pendapatan_bulanan' => $validated['pendapatan_bulanan'] ?? $detail['f502'] ?? null,
