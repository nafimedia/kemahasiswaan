            ...
            <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                ...
                <td class="px-4 py-3 text-xs font-mono">
                    <div class="flex items-center gap-2">
                        <div class="w-4 h-4 rounded-full border border-slate-300 dark:border-slate-700 shadow-xs" style={`background-color: ${tag.color}`}></div>
                        <span class="text-slate-700 dark:text-slate-300">{tag.color}</span>
                    </div>
                </td>
